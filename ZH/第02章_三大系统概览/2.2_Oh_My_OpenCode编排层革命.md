...
OpenCode 给出了一个优秀的开源基座，但真正把“单智能体编码工具”推进到“团队式软件生产系统”的，是构建在其插件接口之上的 Oh-My-OpenCode。它位于 `/Users/treaser/Programming/AIAgents/0-clones/oh-my-opencode`，并不是对宿主的大规模 fork，而是沿着插件、钩子、配置与自定义工具四条路径，把一个宿主改造成一层几乎完整的编排操作系统。
